    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="card-tools">
                <ul class="nav nav-pills ml-auto">
                    <li class="nav-item">
                        <a class="nav-link active" href="#revenue-chart" data-toggle="tab">Pelanggan Loyal</a>
                    </li>
                </ul>
            </div>
        </div><!-- /.card-header -->
        <div class="card-body">
            <div class="tab-content p-0">
                ...
                <div class="chart tab-pane active" id="revenue-chart" style="position: relative; height: 300px;">
                    ...
                    <!-- <canvas id="myHanisa" height="100"></canvas> -->
                    <script>
...
<section class="col-lg-10 connectedSortable">
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">
                <i class="fas fa-chart-pie mr-1"></i>
                Analisis Nominal Uang Terbanyak
            </h3>
            <div class="card-tools">
                <ul class="nav nav-pills ml-auto">
                    <li class="nav-item">
                        <a class="nav-link active" href="#revenue-chart" data-toggle="tab">Nominal Uang Terbesar</a>
                    </li>
                </ul>
            </div>
        </div><!-- /.card-header -->
        <div class="card-body">
            <div class="tab-content p-0">
                ...
                <div class="chart tab-pane active" id="revenue-chart" style="position: relative; height: 300px;">
                    <?php
                    foreach ($grafik_uang as $key => $value) {
                        $nama_lengkap[] = $value->nama_lengkap;
                        $grand_total[] = $value->grand_total;
                    }
                    ?>
                    <canvas id="myHanisa" height="100" style="height: 100px;"></canvas>
                    <!-- <canvas id="myHanisa" height="100"></canvas> -->
                    <script>
                        var ctx = document.getElementById('myHanisa');
                        var myHanisa = new Chart(ctx, {
                            type: 'bar',
                            data: {
                                labels: <?= json_encode($nama_lengkap) ?>,
                                datasets: [{
                                    label: 'Grafik Nominal Uang Terbesar',
        ...
        <div class="card-body">
            <div class="tab-content p-0">
                ...
                <div class="chart tab-pane active" id="revenue-chart" style="position: relative; height: 300px;">
                    ...
                    ?>
                    <canvas id="mymaharani" height="100" style="height: 100px;"></canvas>
                    <!-- <canvas id="mymaharani" height="100"></canvas> -->
                    <script>
                        var ctx = document.getElementById('mymaharani');
                        var mymaharani = new Chart(ctx, {
                            type: 'bar',
                            data: {
