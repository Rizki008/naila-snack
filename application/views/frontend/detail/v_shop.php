                        ...
                        <div class="product__discount__slider owl-carousel">
                            <?php foreach ($diskon as $key => $prodis) { ?>
                                <div class="col-lg-4">
                                    ...
                                    echo form_hidden('price', $prodis->harga);
                                    ...
                                    <div class="product__discount__item">
                                        ...
                                        <div class="product__discount__item__text">
                                            ...
                                            <div class="product__item__price">Rp. <?= number_format($prodis->harga, 0) ?> <span>Rp. <?= number_format($prodis->harga - $prodis->diskon, 0) ?></span></div>
                                        </div>
                                    </div>
                                    <?php echo form_close() ?>
                                </div>
