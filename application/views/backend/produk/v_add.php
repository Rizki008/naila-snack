			...
			<div class="row">
				...
				<div class="col-sm-4">
					...
					<div class="form-group">
						...
						<input name="satuan" type="text" min="0" class="form-control" placeholder="satuan Produk" value="<?= set_value('satuan') ?>">
					</div>
				</div>
			</div>
			<!-- text input -->
			...
			<div class="row">
				<div class="col-sm-6">
					<div class="form-group">
						...
						<input type="file" name="images" class="form-control" id="preview_gambar" required>
					</div>
				</div>
