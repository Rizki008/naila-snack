			...
			<div class="row">
				<div class="col-sm-4">
					<div class="form-group">
						...
						<input name="nama_diskon" type="text" class="form-control" placeholder="Nama Produk" value="<?= $diskon->nama_diskon ?>">
					</div>
				</div>
				...
				<div class="col-sm-4">
					...
					<div class="form-group">
						...
						<input name="diskon" type="number" class="form-control" placeholder="Besar Diskon" value="<?= $diskon->diskon ?>">
					</div>
				</div>
				<div class="col-sm-4">
					<!-- text input -->
					<div class="form-group">
						...
						<input name="tgl" type="date" class="form-control" placeholder="Tanggal Selesai" value="<?= $diskon->tgl_selesai ?>">
					</div>
				</div>
				<div class="col-sm-4">
					<!-- text input -->
					<div class="form-group">
						<label>Harga Produk</label>
						<input name="harga" type="text" min="0" class="harga form-control" placeholder="Harga Produk" value="<?= $diskon->harga ?>" readonly>
					</div>
				</div>
			</div>
			<div class="form-group">
